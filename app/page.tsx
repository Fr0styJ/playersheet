      ...
      <main>
          ...
          >
            ...
            >
                    ...
                    {mods.map((m, j) => (
                      <label key={m}>
                        ...
                        <FittedEntry
                          ...
                          onChange={(e) => set(abbr + ':' + m, e.target.value)}
                        />
                      </label>
                    ))}
                  </div>
              ...
              {[
                ...
                <div key={x}>
                  {input('move:' + x + ':rate', 735, 369 + i * 21.4, 88, 20)}
                  {i > 0 &&
                    i < 5 &&
                    input(
                      'move:' + x + ':load',
              ...
              {[
                ...
                <div key={x}>
                  ...
                  {input('save:' + x + ':save', 1052, 375 + i * 37.4, 48, 23)}
                </div>
              ))}
                ...
                Array.from({ length: group === 0 ? 16 : 12 }, (_, n) => {
                  ...
                  return (
                    <Checkbox
                      ...
                      checked={sheet.ammo[group]?.values['used' + n] === 'true'}
                      onCheckedChange={(v) =>
              ...
              {text('Special abilities (continued)', 310, 1102, 237, 352, 23.8)}
              {Array.from({ length: 28 }, (_, i) => {
                ...
                return (
                  <div key={i}>
                    ...
                    {entry('skills', i, 'Rating / slots', x + 164, y, 23, 23)}
                    {entry('skills', i, 'Check / modifier', x + 200, y, 23, 23)}
                  </div>
                );
              })}
            </fieldset>
        ...
        <div className="extras">
          <p className="mobile-hint">
            Tap any line to edit. Use “Enlarge to edit” for larger fields; swipe
            across the sheet on a phone. Changes save in this browser.
          </p>
          <details>
            <summary>Additional fields & campaign notes</summary>
            <p>
              Extra entries stay here so the original sheet keeps its layout.
            </p>
            {[
              'Maximum HP',
              'Adventure notes',
                      ...
                      setSheet((s) => ({
                        ...
                        custom: s.custom.map((r, n) =>
                          n === i
                            ? {
                                ...r,
                                values: { ...r.values, title: e.target.value },
                              }
                            : r,
                        ),
                      }))
          ...
          <button className="new-character" onClick={() => setPending(blank())}>
            New character
          </button>
        </div>
      </main>
